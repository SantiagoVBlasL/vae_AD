#!/usr/bin/env python3
"""Read-only subject-pool audit for the recover035 metadata-rescue retrain.
...
Outputs to: results/revision_bspc_2026/recover035_full5x5_subject_pool_audit/
...
DEFAULT_OUTPUT = RESULTS / "recover035_full5x5_subject_pool_audit"
...
def main() -> int:
    ...
    overall = bool(pool["ok"].all()) and bool(v035.get("all_checks_pass", False)) and bool(v128.get("correctly_excluded", False))
