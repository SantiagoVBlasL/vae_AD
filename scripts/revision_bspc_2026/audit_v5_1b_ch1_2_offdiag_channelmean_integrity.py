#!/usr/bin/env python3
"""Read-only integrity audit for v5.1b [1,2] offdiag_channelmean FULL run."""
...
OUT_DIR = RESULTS / "adni_v5_1b_ch1_2_offdiag_channelmean_integrity_audit"
FOLDS = [1, 2, 3, 4, 5]
...
def final_decision(inv: pd.DataFrame, pred: pd.DataFrame) -> str:
    ...
    return f"""# v5.1b [1,2] Offdiag-Channelmean Integrity Decision
