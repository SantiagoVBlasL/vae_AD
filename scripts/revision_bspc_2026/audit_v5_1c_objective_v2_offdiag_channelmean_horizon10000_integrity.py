#!/usr/bin/env python3
"""Read-only integrity audit for v5.1c objective-v2 horizon10000/cycles125 FULL run.
...
OUT_DIR = RESULTS / "adni_v5_1c_objective_v2_offdiag_channelmean_horizon10000_integrity_audit"
FOLDS = [1, 2, 3, 4, 5]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--v51c10000-current-run", type=Path, default=V51C10000_CURRENT_RUN)
    parser.add_argument("--v51c10000-current-readout", type=Path, default=V51C10000_CURRENT_READOUT)
...
def main() -> int:
    ...
    v51c10000_current_run = resolve(args.v51c10000_current_run)
    v51c10000_current_readout = resolve(args.v51c10000_current_readout)
    ...
    ref_specs = [
        ("v51c10000_current_loss", v51c10000_current_run, v51c10000_current_readout),
    ...
    if args.dry_run:
        ...
        print(f"Reference v5.1c 10000 current-loss: {v51c10000_current_run}")
    ...
    final_text = f"""# v5.1c Objective-v2 Horizon10000/Cycles125 Integrity Decision
