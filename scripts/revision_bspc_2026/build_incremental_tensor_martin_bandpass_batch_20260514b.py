#!/usr/bin/env python3
"""Build an incremental no-Python-bandpass tensor for Martin batch 20260514b.

This script uses only rows marked import_ready_new=yes by the batch audit. It
does not assemble with v5.1_batch20260514 and does not train.
"""
...
DEFAULT_LOCAL_SYMLINK = (
    PROJECT_ROOT / "data" / "revision_bspc_2026" / "adni_v5_1_batch20260514b_incremental_no_pybandpass"
)

DATASET_NAME = "adni_v5_1_batch20260514b_incremental_no_pybandpass"
EXPECTED_IMPORT_READY_N = 59
FINAL_TENSOR_NAME = "INCREMENTAL_TENSOR_MARTIN_BANDPASS_BATCH20260514B.npz"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build incremental tensor for Martin bandpass batch 20260514b.",
...
def write_outputs(
    ...
    readme_lines = [
        "# ADNI v5.1 Martin Bandpass Batch 20260514b Incremental Tensor",
        "",
        ...
        "- No training was run.",
        "- This output is not assembled with v5.1_batch20260514.",
        "",
        "## Tensor",
        "",
        ...
        "## Next Step",
        "",
        "Review this incremental output before any assembly with v5.1_batch20260514. Do not train until the final v5.1 dataset is explicitly confirmed.",
    ]
