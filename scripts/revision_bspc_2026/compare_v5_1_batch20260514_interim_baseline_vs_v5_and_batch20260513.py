#!/usr/bin/env python3
"""Compare v5.1 batch20260514 [1,0,2] interim baseline against prior datasets.
...
RUNS: Dict[str, Dict[str, Any]] = {
    ...
    "v5_1_batch20260513_ch1_0_2_interim_baseline": {
        "label": "v5.1 batch20260513 no-Python-bandpass interim [1,0,2]",
        "big_disk_dir": BIG_DISK / "adni_v5_1_batch20260513_ch1_0_2_interim_baseline",
        "local_dir": LOCAL_RESULTS / "adni_v5_1_batch20260513_ch1_0_2_interim_baseline",
        "channels": [1, 0, 2],
        "reference": True,
    },
}

DEFAULT_OUTPUT_DIR = LOCAL_RESULTS / "adni_v5_1_batch20260514_interim_baseline_vs_v5_and_batch20260513"
METRICS_SUFFIX = (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Compare v5.1 batch20260514 interim baseline metrics against v5 and batch20260513.",
...
def build_deltas(summary: pd.DataFrame) -> pd.DataFrame:
    target = "v5_1_batch20260514_ch1_0_2_interim_baseline"
    refs = ["v5_ch1_0_2_baseline", "v5_1_batch20260513_ch1_0_2_interim_baseline"]
    rows: List[Dict[str, Any]] = []
...
def write_readme(output_dir: Path, summary: pd.DataFrame, deltas: pd.DataFrame, run_ts: str) -> None:
    lines = [
        "# v5.1 batch20260514 No-Python-Bandpass Interim Baseline Comparison",
        "",
        f"Generated: {run_ts}",
        "",
    ...
    lines += ["", "## Deltas", ""]
    if deltas.empty:
        lines.append("No deltas available yet, most likely because the v5.1 batch20260514 run has not been trained.")
    else:
        lines += [
...
def main() -> None:
    ...
    print("=== v5.1 batch20260514 interim baseline vs v5 and batch20260513 ===")
