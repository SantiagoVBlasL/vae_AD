#!/usr/bin/env python3
"""Compare v5.1 batch20260514b [1,0,2] final-candidate baseline against the interim run.
...
RUNS: Dict[str, Dict[str, Any]] = {
    "v5_1_batch20260514b_ch1_0_2_final_candidate_baseline": {
        "label": "v5.1 batch20260514b no-Python-bandpass final-candidate [1,0,2]",
        "big_disk_dir": BIG_DISK / "adni_v5_1_batch20260514b_ch1_0_2_final_candidate_baseline",
        "local_dir": LOCAL_RESULTS / "adni_v5_1_batch20260514b_ch1_0_2_final_candidate_baseline",
        "channels": [1, 0, 2],
        "reference": False,
    },
    "v5_1_batch20260514_ch1_0_2_interim_baseline": {
        "label": "v5.1 batch20260514 no-Python-bandpass interim [1,0,2]",
        "big_disk_dir": BIG_DISK / "adni_v5_1_batch20260514_ch1_0_2_interim_baseline",
        "local_dir": LOCAL_RESULTS / "adni_v5_1_batch20260514_ch1_0_2_interim_baseline",
        "channels": [1, 0, 2],
        "reference": True,
    },
}

DEFAULT_OUTPUT_DIR = LOCAL_RESULTS / "adni_v5_1_batch20260514b_final_candidate_baseline_vs_batch20260514_interim"
METRICS_SUFFIX = (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Compare v5.1 batch20260514b final-candidate baseline metrics against batch20260514 interim.",
...
def build_deltas(summary: pd.DataFrame) -> pd.DataFrame:
    target = "v5_1_batch20260514b_ch1_0_2_final_candidate_baseline"
    refs = ["v5_1_batch20260514_ch1_0_2_interim_baseline"]
    rows: List[Dict[str, Any]] = []
...
def write_readme(output_dir: Path, summary: pd.DataFrame, deltas: pd.DataFrame, run_ts: str) -> None:
    lines = [
        "# v5.1 batch20260514b No-Python-Bandpass Final-Candidate Baseline Comparison",
        "",
        f"Generated: {run_ts}",
        "",
    ...
    lines += ["", "## Deltas", ""]
    if deltas.empty:
        lines.append("No deltas available yet, most likely because the v5.1 batch20260514b run has not been trained.")
    else:
        lines += [
...
def main() -> None:
    ...
    print("=== v5.1 batch20260514b final-candidate baseline vs batch20260514 interim ===")
    ...
    deltas.to_csv(args.output_dir / "delta_vs_references.csv", index=False)
    command = {
