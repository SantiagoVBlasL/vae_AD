#!/usr/bin/env python3
"""Dry-run/run wrapper for the ADNI expanded V4 [4,1,0] channel variant."""
...
DEFAULT_CONFIG = PROJECT_ROOT / "configs" / "runs" / "adni_expanded_v4_beta25_ch4_1_0.json"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build and optionally execute the V4 [4,1,0] full-config retraining command.",
