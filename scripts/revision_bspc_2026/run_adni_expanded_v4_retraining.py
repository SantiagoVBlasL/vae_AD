#!/usr/bin/env python3
"""Dry-run/run wrapper for ADNI_expanded_v4_all_available retraining."""
...
DEFAULT_CONFIG = PROJECT_ROOT / "configs" / "runs" / "adni_expanded_v4_beta25_static3.json"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build and optionally execute the v4 expanded ADNI retraining command.",
