#!/usr/bin/env python3
"""
Dry-run / run wrapper for ADNI v5.1 batch20260514 interim no-Python-bandpass baseline.
...
Dry-run:
    python scripts/revision_bspc_2026/run_adni_v5_1_batch20260514_ch1_0_2_interim_baseline.py --dry-run

Real run (requires explicit confirmation and output_dir symlink to /media/diego/Datos target):
    python scripts/revision_bspc_2026/run_adni_v5_1_batch20260514_ch1_0_2_interim_baseline.py --confirm-training
"""
...
DEFAULT_CONFIG = (
    ...
    / "configs"
    / "runs"
    / "adni_v5_1_batch20260514_ch1_0_2_interim_baseline.json"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build and optionally execute the ADNI v5.1 batch20260514 interim "
