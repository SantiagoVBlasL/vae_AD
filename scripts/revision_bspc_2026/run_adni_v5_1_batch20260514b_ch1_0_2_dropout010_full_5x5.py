#!/usr/bin/env python3
"""Prepare/run the controlled dropout=0.10 FULL 5x5 confirmation.
...
DEFAULT_CONFIG = PROJECT_ROOT / "configs/runs/adni_v5_1_batch20260514b_ch1_0_2_dropout010_full_5x5.json"
...
COMPARISON_SCRIPT = PROJECT_ROOT / "scripts/revision_bspc_2026/compare_v5_1_batch20260514b_dropout010_full_5x5.py"
...
def assert_only_dropout_scientific_diff(source: Dict[str, Any], target: Dict[str, Any]) -> None:
    ...
    require_equal(diffs, {"dropout_rate_vae": (0.15, 0.10)}, "scientific parameter diffs")
...
OUT_COMPARISON_DIR = PROJECT_ROOT / "results/revision_bspc_2026/adni_v5_1_batch20260514b_ch1_0_2_dropout010_full_5x5_comparison"
...
def write_manifest(config_path: Path, config: Dict[str, Any], stage_a: Sequence[str], stage_b: Sequence[str], comparison: Sequence[str]) -> Path:
    ...
    manifest = {
        ...
        "controlled_change": "dropout_rate_vae 0.15 -> 0.10",
...
def main() -> int:
    ...
    print(f"Mode           : {mode}")
    print("Controlled diff: dropout_rate_vae 0.15 -> 0.10")
