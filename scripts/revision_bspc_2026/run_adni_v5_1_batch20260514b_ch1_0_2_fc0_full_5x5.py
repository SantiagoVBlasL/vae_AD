#!/usr/bin/env python3
"""Prepare/run ADNI v5.1 batch20260514b [1,0,2] fc0 FULL 5x5.
...
DEFAULT_CONFIG = PROJECT_ROOT / "configs/runs/adni_v5_1_batch20260514b_ch1_0_2_fc0_full_5x5.json"
...
def validate_config(config: Dict[str, Any]) -> None:
    ...
    require_equal(params["intermediate_fc_dim_vae"], 0, "intermediate_fc_dim_vae")
