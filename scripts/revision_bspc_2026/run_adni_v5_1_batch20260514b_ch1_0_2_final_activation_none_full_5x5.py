#!/usr/bin/env python3
"""Prepare/run ADNI v5.1 batch20260514b [1,0,2] final_activation=none FULL 5x5.
...
DEFAULT_CONFIG = PROJECT_ROOT / "configs/runs/adni_v5_1_batch20260514b_ch1_0_2_final_activation_none_full_5x5.json"
...
def validate_config(config: Dict[str, Any]) -> None:
    ...
    require_equal(params["vae_final_activation"], "none", "vae_final_activation")
...
def write_manifest(
    ...
    manifest = {
        ...
        "intermediate_fc_dim_vae": config["parameters"]["intermediate_fc_dim_vae"],
...
def main() -> int:
    ...
    print(f"VAE schedule   : outer={params['outer_folds']}, inner={params['inner_folds']}, latent_dim={params['latent_dim']}, epochs={params['epochs_vae']}, cycles={params['cyclical_beta_n_cycles']}, cycle_len={params['epochs_vae'] / params['cyclical_beta_n_cycles']}, T0={params['lr_scheduler_T0']}, batch_size={params['batch_size']}")
