#!/usr/bin/env python3
"""Prepare/run a Fold-4-only horizon extension diagnostic for locked [1,0,2].

Default mode is dry-run/preflight. Real training requires --confirm-training.
The scientific config diff versus the locked FULL baseline is restricted to:
  epochs_vae: 3840 -> 4160
  cyclical_beta_n_cycles: 48 -> 52
...
DEFAULT_CONFIG = PROJECT_ROOT / "configs/runs/adni_v5_1_batch20260514b_ch1_0_2_fold4_horizon4160_cycles52.json"
TARGET_FOLD = 4
