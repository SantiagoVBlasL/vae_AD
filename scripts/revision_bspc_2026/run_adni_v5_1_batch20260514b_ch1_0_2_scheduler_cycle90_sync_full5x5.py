#!/usr/bin/env python3
"""Prepare/run the controlled scheduler-cycle sensitivity FULL 5x5 experiment.
...
INTEGRITY_AUDIT_SCRIPT = PROJECT_ROOT / "scripts/revision_bspc_2026/audit_v5_1_batch20260514b_scheduler_cycle90_sync_integrity.py"
SCHEDULE_PHASE_SCRIPT = PROJECT_ROOT / "scripts/revision_bspc_2026/audit_scheduler_cycle90_phase_preflight.py"

OUT_COMPARISON_DIR = PROJECT_ROOT / "results/revision_bspc_2026/scheduler_cycle90_sync_full5x5_comparison"
