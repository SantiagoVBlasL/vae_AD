#!/usr/bin/env python3
"""
Dry-run / run wrapper for ADNI v5.1 GECN9 no-Python-bandpass baseline.
...
Dry-run:
    python scripts/revision_bspc_2026/run_adni_v5_1_gecn9_no_pybandpass_ch1_0_2_baseline.py --dry-run

Real run (requires output_dir symlink to /media/diego/Datos target):
    python scripts/revision_bspc_2026/run_adni_v5_1_gecn9_no_pybandpass_ch1_0_2_baseline.py
"""
...
DEFAULT_CONFIG = (
    ...
    / "configs"
    / "runs"
    / "adni_v5_1_gecn9_no_pybandpass_ch1_0_2_baseline.json"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build and optionally execute the ADNI v5.1 GECN9 no-Python-bandpass "
            "baseline training command for manuscript channels [1,0,2]."
        ),
