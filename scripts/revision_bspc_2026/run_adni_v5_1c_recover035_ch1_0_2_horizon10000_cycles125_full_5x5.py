#!/usr/bin/env python3
"""Launcher for v5.1c recover035 horizon10000/cycles125 FULL 5x5.

Default is dry-run/preflight behavior. Real training requires
--confirm-training. Compared with the v5.1c horizon4480/cycles56 run, the only
allowed scientific differences are:
...
SOURCE_CONFIG = PROJECT_ROOT / "configs/runs/adni_v5_1c_recover035_ch1_0_2_horizon4480_cycles56_full_5x5.json"
DEFAULT_CONFIG = PROJECT_ROOT / "configs/runs/adni_v5_1c_recover035_ch1_0_2_horizon10000_cycles125_full_5x5.json"
STAGE_B_SCRIPT = PROJECT_ROOT / "scripts/revision_bspc_2026/run_v5_1_batch20260514b_mfrsplit_3840_classifier_only_sweep.py"
COMPARISON_SCRIPT = PROJECT_ROOT / "scripts/revision_bspc_2026/compare_v5_1c_horizon10000_cycles125_vs_v5_1b_and_v5_1c4480.py"
INTEGRITY_SCRIPT = PROJECT_ROOT / "scripts/revision_bspc_2026/audit_v5_1c_horizon10000_cycles125_integrity.py"
...
def validate_long_horizon_diff(source: Dict[str, Any], target: Dict[str, Any]) -> None:
    ...
    if param_diffs != allowed_param_diffs:
        raise RuntimeError(f"Unexpected parameter diffs vs v5.1c horizon4480: {param_diffs}")
    ...
    if diffs != allowed_path_diffs:
        raise RuntimeError(f"Unexpected path diffs vs v5.1c horizon4480: {sorted(diffs)}")
...
def validate_config(config: Dict[str, Any], source: Dict[str, Any]) -> None:
    validate_long_horizon_diff(source, config)
...
def write_manifest(
    ...
    payload = {
        ...
        "controlled_change_vs_v5_1c_horizon4480": "epochs_vae 4480->10000; cyclical_beta_n_cycles 56->125",
...
def main() -> int:
    ...
    print("Config diff    : epochs_vae 4480->10000 and cyclical_beta_n_cycles 56->125 only vs v5.1c horizon4480")
