#!/usr/bin/env python3
"""Preflight/launcher for recover035_ch1only_latent384_beta3p75_T80_h10000_p560_full5x5.
...
DEFAULT_CONFIG = (
    PROJECT_ROOT / "configs/runs/adni_v5_1c_recover035_ch1only_latent384_beta3p75_T80_h10000_p560_full5x5.json"
)
DEFAULT_PREFLIGHT_DIR = (
    PROJECT_ROOT / "results/revision_bspc_2026/recover035_ch1only_latent384_beta3p75_T80_h10000_p560_full5x5_preflight"
)
...
RUN_ID = "recover035_ch1only_latent384_beta3p75_T80_h10000_p560_full5x5"
...
def write_preflight_outputs(
    ...
    report = [
        "# ch1-only latent384 beta3p75 FULL 5x5 Preflight",
        "",
        f"Run ID: `{RUN_ID}`",
        ...
        "",
        "- `channels_to_use: [1,0,2] -> [1]`",
        "- `selected_channel_names: [Pearson_Full_FisherZ_Signed, Pearson_OMST_GCE_Signed_Weighted, MI_KNN_Symmetric] -> [Pearson_Full_FisherZ_Signed]`",
