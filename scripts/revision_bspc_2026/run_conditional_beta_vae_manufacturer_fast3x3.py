#!/usr/bin/env python3
"""Real launcher for conditional Manufacturer beta-VAE FAST 3x3 candidates.
...
OUTPUT_ROOT = PROJECT_ROOT / "results/revision_bspc_2026/conditional_beta_vae_manufacturer_fast3x3"
BIG_DISK_RUN_ROOT = Path("/media/diego/Datos/vae_AD_results/revision_bspc_2026/conditional_beta_vae_manufacturer_fast3x3/runs")
...
AGGREGATOR_SCRIPT = PROJECT_ROOT / "scripts/revision_bspc_2026/aggregate_conditional_beta_vae_manufacturer_fast3x3.py"
...
def write_manifest(output_root: Path, rows: List[Dict[str, Any]], dry_run: bool) -> pd.DataFrame:
    ...
    lines = [
        "# Conditional beta-VAE Manufacturer FAST 3x3",
        "",
