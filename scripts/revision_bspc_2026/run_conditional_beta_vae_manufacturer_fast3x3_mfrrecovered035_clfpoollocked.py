#!/usr/bin/env python3
"""Launcher for conditional Manufacturer beta-VAE FAST 3x3 — recovered-035 VAE pool, classifier pool locked.
...
OUTPUT_ROOT = PROJECT_ROOT / "results/revision_bspc_2026/conditional_beta_vae_manufacturer_fast3x3_mfrrecovered035_clfpoollocked"
BIG_DISK_RUN_ROOT = Path("/media/diego/Datos/vae_AD_results/revision_bspc_2026/conditional_beta_vae_manufacturer_fast3x3_mfrrecovered035_clfpoollocked/runs")
...
AGGREGATOR_SCRIPT = PROJECT_ROOT / "scripts/revision_bspc_2026/aggregate_conditional_beta_vae_manufacturer_fast3x3_mfrrecovered035_clfpoollocked.py"
...
def run_status_audit(args: argparse.Namespace) -> int:
    ...
    print(f"\n=== Candidate Status Audit (mfrrecovered035_clfpoollocked) ===")
...
def write_manifest(output_root: Path, rows: List[Dict[str, Any]], dry_run: bool, patched_metadata_path: Path) -> pd.DataFrame:
    ...
    lines = [
        "# Conditional beta-VAE Manufacturer FAST 3x3 — recovered-035 VAE pool, classifier pool locked",
        "",
